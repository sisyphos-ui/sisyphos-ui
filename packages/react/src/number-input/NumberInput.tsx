...
export interface NumberInputProps extends Omit<
  ...
  "value" | "defaultValue" | "onChange" | "type" | "size" | "min" | "max" | "step" | "prefix"
> {
  value?: number | null;
    ...
    return (
      ...
      >
        {label && (
          <label
            htmlFor={fieldId}
            className={cx("sisyphos-number-input-label", error && "error", required && "required")}
          >
            {label}
          </label>
        )}
        ...
        {error && errorMessage && (
          <span className="sisyphos-number-input-error" role="alert">
            {errorMessage}
          </span>
        )}
      </div>
